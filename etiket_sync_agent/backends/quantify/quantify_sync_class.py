...
class QuantifySync(SyncSourceFileBase):
    ...
    @staticmethod
    def checkLiveDataset(configData: QuantifyConfigData, syncIdentifier: SyncItems, maxPriority: bool) -> bool:
        if not maxPriority:
            return False
    ...
    @staticmethod
    def syncDatasetNormal(configData: QuantifyConfigData, syncIdentifier: SyncItems):
    ...
    @staticmethod
    def syncDatasetLive(configData: QuantifyConfigData, syncIdentifier: SyncItems):
        create_ds_from_quantify(configData, syncIdentifier, False)
        dataset_path = pathlib.Path(os.path.join(configData.quantify_directory, syncIdentifier.dataIdentifier))
...
def create_ds_from_quantify(configData: QuantifyConfigData, syncIdentifier: SyncItems, live : bool):
